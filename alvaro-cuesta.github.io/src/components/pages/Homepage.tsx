...
export const Homepage: React.FC<HomepageProps> = ({ siteRenderMeta }) => (
  ...
  >
    <section>
      ...
      <p>
        I have a very unique background as a developer: I started my career as a
        systems engineer, so I have a very deep understanding of low-level
      ...
      <p>
        Be it HTML, CSS, or modern JavaScript frameworks like React, I have been
        there and done that.
      </p>
    ...
    <section id="projects">
      ...
      <p>
        ...
        to take a peek at all my public open-source projects, but here are some
        of my favorites:
      </p>
      <ul>
        <Project
        ...
        >
          View <Link href="https://www.shadertoy.com/">ShaderToy</Link> effects
          in Virtual Reality.
        </Project>
        ...
        <li>...plus tons of contributions to other open-source projects! 🎉</li>
      </ul>
    </section>
  </Template>
);
