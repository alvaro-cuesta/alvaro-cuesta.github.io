      ...
      <main className="container">
        <section>
          ...
          <p>
            ...
            <strong>full-stack software engineer</strong> based in Madrid,
            Spain.
          </p>
          <p>
            I have a very unique background as a developer: I started my career
            as a systems engineer, so I have a very deep understanding of
            low-level topics like operating systems, networking, and hardware.
          </p>
          <p>
            That does not mean I am not a great web developer! I switched my
            focus to web development out of pure love for the web platform, and
            I have been working with it for the past ~15 years, learning a ton
